...
const QuoteGenerator = React.memo(({ onInteract }) => {
    ...
    return (
        <div className="quote-generator" onClick={handleOnClick} onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
            {showToolTip && <div className="tooltip">Quote Generator</div>}
            <div className="frase">
                {quote && (
